...
public abstract class ServerSentEvent {
    ...
    public static ServerSentEvent create(String data) {
        return de.heikoseeberger.akkasse.scaladsl.model.ServerSentEvent.apply(data, stringNone, stringNone, intNone);
    }
    ...
    public static ServerSentEvent create(String data, String type) {
        return de.heikoseeberger.akkasse.scaladsl.model.ServerSentEvent.apply(data, type);
    }
    ...
    public static ServerSentEvent create(String data, String type, String id) {
        return de.heikoseeberger.akkasse.scaladsl.model.ServerSentEvent.apply(data, type, id);
    }
    ...
    public static ServerSentEvent create(String data, int retry) {
        return de.heikoseeberger.akkasse.scaladsl.model.ServerSentEvent.apply(data, retry);
    }
    ...
    public static ServerSentEvent create(String data,
                                         ...
                                         Optional<String> id,
                                         OptionalInt retry) {
        return de.heikoseeberger.akkasse.scaladsl.model.ServerSentEvent.apply(
