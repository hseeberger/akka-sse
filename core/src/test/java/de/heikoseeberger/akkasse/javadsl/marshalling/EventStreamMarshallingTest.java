...
import static de.heikoseeberger.akkasse.javadsl.model.MediaTypes.TEXT_EVENT_STREAM;
...
public class EventStreamMarshallingTest extends JUnitRouteTest {
    ...
    public void testToEventStream() {
        ...
        final ByteString expectedEntity = events
                .stream()
                .map(e -> ((de.heikoseeberger.akkasse.scaladsl.model.ServerSentEvent) e).encode())
